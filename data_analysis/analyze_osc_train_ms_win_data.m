function output_struct=analyze_osc_train_ms_win_data(dataDir,filenames,stringa,par)
...
for ifile=1:nfiles
    ...
    if n_neu_this<n_neu_min
        ...
        for i_sample=1:n_sample
            ...
            save(fullfile(dataDir,strrep(filenames{ifile},'.mat',['_measures_ms_sofar.mat'])),'output_measures','neu_ind_mat','par','par_this'); % better to save for each sample
        end
    end
    % keyboard;
