function output_struct=multi_train_range_anal_all_title(stringa_dir_batch,par,ranged_par,ranged_stringa,ranged_stringa_tex)
...
% pos_this=[0.1852    0.1502    0.7198    0.7406]; % better option for fitting both with higher fig_pos
pos_this=[0.2145    0.1502    0.6905    0.7406]; % better option for fitting both with higher fig_pos - BEST OPTION FOR 3 DECIMAL DIGITS - USE THIS
    ...
    for kk=10
        ...
        for i=1:n_k_ratio
            ...
            if strcmp(char(ranged_stringa_tex(1)),'\Sigma') || strcmp(char(ranged_stringa_tex(1)),'m')
                title([char(ranged_stringa_tex(1)) '=' num2str(ranged_par1_vect(i),'%.2f')],'FontWeight','normal');
            elseif strcmp(char(ranged_stringa_tex(1)),'p_{fail}')
                title([char(ranged_stringa_tex(1)) '=' num2str(ranged_par1_vect(i),'%.1f')],'FontWeight','normal');
            ...
            if ismember(i,ylabel_ind)
                ...
                if strcmp(par.suf1,'osc') % we only put legend for osc trains
                    legh=legend([clh(1) dlh(1)],{'pseudo-rhythmic','non-rhythmic'},'Position',[0.2238 0.7029 0.4474 0.1780]);
                    ...
                    eval(['legh2=legend(ah1,clh,' stringa_legend(1:end-1) ',''Position'',[0.2238 0.3896 0.2719 0.3027],''AutoUpdate'',''off'');']);
                    ah1.Visible='off';
                end
            end
            figure_name=[stringa '_' strrep(field_names{kk},'.','_') '_vs_' char(ranged_stringa(3)) '_m' char(ranged_stringa(2)) '_at_' char(ranged_stringa(1)) '' num2str(i) '_longn_title.png']; % long measure name
            ...
            set(gcf,'Position',fig_pos_this);
            set(gca,'Position',pos_this);
            figure_name=[stringa '_' strrep(field_names{kk},'.','_') '_vs_' char(ranged_stringa(2)) '_m' char(ranged_stringa(3)) '_at_' char(ranged_stringa(1)) '' num2str(i) '_longn_title.png'];
            hgexport(fh,figure_name,mystyle,'Format','png');
        end
        ...
        for i=1:n_g_exc
            ...
            if strcmp(char(ranged_stringa_tex(2)),'\Sigma') || strcmp(char(ranged_stringa_tex(2)),'m')
                title([char(ranged_stringa_tex(2)) '=' num2str(ranged_par2_vect(i),'%.2f')],'FontWeight','normal');
            elseif strcmp(char(ranged_stringa_tex(2)),'p_{fail}')
                title([char(ranged_stringa_tex(2)) '=' num2str(ranged_par2_vect(i),'%.1f')],'FontWeight','normal');
            elseif strcmp(char(ranged_stringa_tex(2)),'f_0') || strcmp(char(ranged_stringa_tex(2)),'r_0')
                title([char(ranged_stringa_tex(2)) '=' num2str(ranged_par2_vect(i),'%.0f') 'Hz'],'FontWeight','normal');
            end
            set(gcf,'Position',fig_pos_this);
            set(gca,'Position',pos_this);
            figure_name=[stringa '_' strrep(field_names{kk},'.','_') '_vs_' char(ranged_stringa(3)) '_m' char(ranged_stringa(1)) '_at_' char(ranged_stringa(2)) '' num2str(i) '_longn_title.png'];
            hgexport(fh,figure_name,mystyle,'Format','png');
            ...
            set(gcf,'Position',fig_pos_this);
            set(gca,'Position',pos_this);
            figure_name=[stringa '_' strrep(field_names{kk},'.','_') '_vs_' char(ranged_stringa(1)) '_m' char(ranged_stringa(3)) '_at_' char(ranged_stringa(2)) '' num2str(i) '_longn_title.png'];
            hgexport(fh,figure_name,mystyle,'Format','png');
        end
        ...
        for i=1:n_g_inh
            ...
            if strcmp(char(ranged_stringa_tex(3)),'\Sigma') || strcmp(char(ranged_stringa_tex(3)),'m')
                title([char(ranged_stringa_tex(3)) '=' num2str(ranged_par3_vect(i),'%.2f')],'FontWeight','normal');
            elseif strcmp(char(ranged_stringa_tex(3)),'p_{fail}')
                title([char(ranged_stringa_tex(3)) '=' num2str(ranged_par3_vect(i),'%.1f')],'FontWeight','normal');
            elseif strcmp(char(ranged_stringa_tex(3)),'f_0') || strcmp(char(ranged_stringa_tex(3)),'r_0')
                title([char(ranged_stringa_tex(3)) '=' num2str(ranged_par3_vect(i),'%.0f') 'Hz'],'FontWeight','normal');
            end
            set(gcf,'Position',fig_pos_this);
            set(gca,'Position',pos_this);
            figure_name=[stringa '_' strrep(field_names{kk},'.','_') '_vs_' char(ranged_stringa(2)) '_m' char(ranged_stringa(1)) '_at_' char(ranged_stringa(3)) '' num2str(i) '_longn_title.png'];
            hgexport(fh,figure_name,mystyle,'Format','png');
            ...
            set(gcf,'Position',fig_pos_this);
            set(gca,'Position',pos_this);
            figure_name=[stringa '_' strrep(field_names{kk},'.','_') '_vs_' char(ranged_stringa(1)) '_m' char(ranged_stringa(2)) '_at_' char(ranged_stringa(3)) '' num2str(i) '_longn_title.png'];
            hgexport(fh,figure_name,mystyle,'Format','png');
        end
        close all;
    end
