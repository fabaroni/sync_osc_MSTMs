function output_struct=plot_train_all_win(stringa_dir_batch,par,ranged_par,ranged_stringa,stringa_label)
...
% pos_this=[0.1879    0.2052    0.7171    0.7198]; % this allows 2 decimal digits, prob enough for main fig
pos_this=[0.2177    0.2052    0.6873    0.7198]; % this allows 3 decimal digits, prob required for SI - WE NEED THIS FOR BOTH
...
for kk=1:length(field_names)
    ...
    for i=1:n_par1
        ...
        figure_name=[stringa '_' strrep(field_names{kk},'.','_') '_vs_' char(ranged_stringa(2)) '_at_' char(ranged_stringa(1)) num2str(i) '_' par.suf1 '_longn.png'];
        ...
        set(gca,'Position',pos_this);
        figure_name=[stringa '_' strrep(field_names{kk},'.','_') '_vs_' char(ranged_stringa(2)) '_at_' char(ranged_stringa(1)) num2str(i) '_' par.suf2 '_longn.png'];
        hgexport(fh,figure_name,mystyle,'Format','png');
    end
