...
stringa_mfile_osc={'generate_oscseq_train','analyze_sinosc_train_ms','analyze_sinosc_train_fooof','analyze_sinosc_train_synfireind'};
stringa_mfile_ple={'generate_sinpleseq_train','analyze_sinosc_train_ms','analyze_sinosc_train_fooof','analyze_sinosc_train_synfireind'};
