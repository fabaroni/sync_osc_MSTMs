...
stringa_mfile_osc={'generate_oscGseq_train','analyze_sinosc_train_ms','analyze_sinosc_train_fooof','analyze_sinosc_train_synfireind'};
stringa_mfile_ple={'generate_expGseq_train','analyze_sinosc_train_ms','analyze_sinosc_train_fooof','analyze_sinosc_train_synfireind'};
...
ranged_par={'par.sigmaGpercent_vect','par.n_neu_vect','par.seed_ind_vect'}; % i,j,k
ranged_stringa={'sigmaGpercent','n_neu','seed_ind'}; % i,j,k
